...
async function connectToWhatsApp() {
    ...
    } catch (e) { addLog("No cloud backup found."); }
    ...
    app.get('/send-otp', async (req, res) => {
        ...
        } catch (e) { addLog(`Error: ${e.message}`); res.json({ error: e.message }); }
    });
